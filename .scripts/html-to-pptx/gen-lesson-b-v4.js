...
const OUT_DIR = path.resolve(PIPE_DIR, '../../basic-1-unit-1-lesson-b-part-1-v4/slides');
const FICHA = path.resolve(PIPE_DIR, '../../basic-1-unit-1-lesson-b-part-1-v4/basic-1-unit-1-lesson-b-part-1-v4-ficha.json');
...
const GAME_BOARD_SRC = path.resolve(
  PIPE_DIR,
  '../../basic-1-unit-1-lesson-b-part-1-v4/slides/game-board.png'
);
...
const mergedOut = path.resolve(PIPE_DIR, '../../basic-1-unit-1-lesson-b-part-1-v4/basic-1-unit-1-lesson-b-part-1-v4.pptx');
