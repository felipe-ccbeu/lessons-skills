...
import { BlockAnimations, Exercise1Data, ExerciseRow, LayoutOffset, LayoutOverrides, StyleOverrides, TextStyleOverride } from '@/lib/types';
  ...
  return (
    <div style={{ position: 'relative', width: 1280, height: 720, background: '#fff', overflow: 'hidden' }}>
      <SlideStagger disabled={editMode}>
        ...
        <SlideStaggerItem disabled={editMode} style={{ position: 'absolute', left: 80, top: 207, width: 1120 }} {...dragProps('instruction')}>
          <p
            style={{
              margin: 0,
        ...
        <SlideStaggerItem disabled={editMode} style={{ position: 'absolute', left: 80, top: 258, width: 1120 }} {...dragProps('rows')}>
          {rows.map((row, i) => (
