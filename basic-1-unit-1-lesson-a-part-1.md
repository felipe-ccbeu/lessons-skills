# Basic 1 - Unit 1 - Lesson A (part 1)

## Metadados
- Fonte: https://docs.google.com/presentation/d/1-q-9gLFdpJC3MElK2i7VkQiEsJCOqYBqzuepjXQ0bDM/edit
- Nº de slides: 24
...
### Slide 1 — Capa
- Texto do slide: "Basic 1 Unit 1 - Lesson A (part 1)"
- Elementos visuais: slide de título simples, identifica o curso e a unidade.

### Slide 2 — Boas-vindas
- Texto do slide: "WELCOME!!"
- Elementos visuais: slide de abertura, tom caloroso e informal (uso de exclamação dupla).

### Slide 3 — Ice Breaker do professor
- Texto do slide: "Teacher's Ice Breaker"
- Elementos visuais: slide-título simples, funciona como marcador de seção (indica que a próxima atividade é conduzida pelo professor, não do livro).

### Slide 4 — Dinâmica em grupo
- Texto do slide: "In groups, find 3 things in common!"
- Elementos visuais: imagem ilustrativa central e um vídeo do YouTube incorporado (timer de 1min30s com música) posicionado no canto — usado para cronometrar a atividade em grupo.
- Observação didática: a atividade é totalmente oral/social, sem relação direta com o livro; funciona como aquecimento (warm-up) e quebra-gelo antes do conteúdo formal.

### Slide 5 — Apresentação do livro
- Texto do slide: "Basic 1!"
- Notas do apresentador: "Teacher, explique para os alunos como o livro funciona (falar que não vão ficar perdidos, que é só olhar no slide para se orientar e que o livro tem exercícios na parte de trás)"
- Observação didática: momento de orientação/gerenciamento de sala de aula — reduz ansiedade dos alunos explicitando a mecânica do curso (slides guiam, livro tem exercícios de reforço no final).

### Slide 6 — Objetivo da aula
- Texto do slide: "use greetings and introductions to introduce yourself in a first day of class conversation 🚀 Today you will be able to..."
- Observação didática: declaração explícita do objetivo de aprendizagem (learning objective) no formato "Today you will be able to...", com emoji de foguete para reforçar tom motivacional. Define a meta comunicativa (não gramatical) da aula: apresentar-se em uma conversa de primeiro dia de aula.
...
- Texto do slide: "What's the difference? / 1. You are from the U.S.A / 2. Are you from the U.S.A?"
- Elementos visuais: as duas frases aparecem empilhadas verticalmente, cada uma separada por uma linha horizontal (divisor), criando comparação lado a lado clara entre afirmativa e interrogativa.
- Observação didática: técnica de contraste mínimo (minimal pair) — mesmas palavras, ordem diferente — para tornar saliente a regra de inversão sujeito-verbo em perguntas com "be".
...
- Notas do apresentador: "Teacher change pairs"
- Observação didática: contextualização local (CCBEU é a própria escola) para tornar a prática pessoal e relevante; fornece modelos de resposta afirmativa e negativa lado a lado, e instrui explicitamente o professor a trocar os pares (fomenta múltiplas interações, não só uma).

### Slide 19 — Fale em pares (prática livre/aberta)
- Texto do slide: "Talk in pairs! Ask and answer questions, change pairs when teacher clap hands / What's your name? / Are you ok? / Are you from the U.S? / Are you from _____? / Are we in Canada? / Are we in _______?"
- Notas do apresentador: "Teacher change pairs"
- Observação didática: evolução do slide 18 — agora com lacunas em branco (_____) que o aluno preenche livremente, e um sinal físico do professor (bater palmas) para rotacionar pares, aumentando a autonomia e o número de interações.

### Slide 20 — Entrevista (produção final)
- Texto do slide: "Interview your partner! Use the questions from the class!"
- Notas do apresentador: "Teacher change pairs"
- Observação didática: tarefa final de produção livre (freer practice) que reaproveita todas as perguntas praticadas anteriormente — fecha o ciclo PPP (Presentation-Practice-Production).

### Slide 21 — Lição completa (recap)
- Texto do slide: "Lesson Complete! / Affirmatives: I'm x I am / You're x You are / We're x We are / Questions: Am I? Are you? Are we? / Questions: What's your name? How are you? Are you from Brazil? / Other words: Hi Hello Fine Thanks Nice to meet you"
- Observação didática: slide de recapitulação estruturado em categorias (afirmativas com forma contraída vs. completa, perguntas gramaticais, perguntas funcionais, vocabulário social) — funciona como resumo visual de tudo o que foi ensinado, organizado para revisão rápida.

### Slide 22 — Celebração
- Texto do slide: "Yes! We did it!"
- Observação didática: fechamento emocional/motivacional, reforço positivo de conclusão da aula.

### Slide 23 — Atribuir prática
- Texto do slide: "Assign practice"
- Elementos visuais: GIF ilustrativo (fonte: Dribbble) relacionado a tarefas/lição de casa.
- Observação didática: sinaliza ao professor o momento de passar a tarefa de casa/prática complementar.

### Slide 24 — Fechamento lúdico
- Texto do slide: "BOOKS CLOSED! LET'S PLAY!"
- Observação didática: transição explícita de "modo livro" para uma atividade lúdica final (jogo), sinalizando que a parte "séria" da aula terminou.

## Estrutura pedagógica da aula
- **Abertura (slides 1-6)**: boas-vindas, ice breaker social com timer, orientação sobre o funcionamento do livro/curso, e declaração explícita do objetivo de aprendizagem ("Today you will be able to..."). Função: reduzir ansiedade, criar vínculo social e situar o aluno antes de qualquer conteúdo gramatical.
- **Desenvolvimento (slides 7-17)**: ciclo de apresentação do conteúdo com o livro — ouvir/repetir → associar diálogo a pessoas → praticar o diálogo → identificar a forma gramatical no próprio texto → destaque explícito da regra ("LOOK!") → contraste mínimo entre afirmativa e interrogativa → segundo destaque de regra. Segue abordagem indutiva: uso da língua antes da análise formal.
- **Prática/exemplos (slides 17-20)**: progressão de prática controlada (perguntas fixas, respostas-modelo fornecidas) → prática semicontrolada (lacunas em branco, rotação de pares) → produção livre (entrevista usando todas as perguntas da aula). Estrutura clássica PPP (Presentation-Practice-Production).
...
- **Instruções de gestão de sala embutidas nas notas do apresentador**: "Teacher change pairs" e "Gesture the actions" aparecem como lembretes operacionais para o professor, não como conteúdo do slide — as notas carregam o "roteiro de regência" da aula.
